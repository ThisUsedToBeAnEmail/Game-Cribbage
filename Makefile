# This Makefile is for the Game::Cribbage extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Game/Cribbage.pm]
#     AUTHOR => [q[LNATION <email@lnation.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     EXE_FILES => [q[bin/cribbage]]
#     LICENSE => q[artistic_2]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Game::Cribbage]
#     PREREQ_PM => { List::Util=>q[0], Rope=>q[0.35], Test::More=>q[0], ntheory=>q[0] }
#     TEST_REQUIRES => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Game/Cribbage.pm]
#     clean => { FILES=>q[Game-Cribbage-*] }
...
TO_INST_PM = lib/Game/Cribbage.pm \
...
DISTNAME = Game-Cribbage
DISTVNAME = Game-Cribbage-0.03
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Game/Cribbage.pm $(INST_MAN3DIR)/Game::Cribbage.$(MAN3EXT) 
...
pure_all :: $(INST_SCRIPT)/cribbage
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/cribbage 

$(INST_SCRIPT)/cribbage : bin/cribbage $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/cribbage
	$(CP) bin/cribbage $(INST_SCRIPT)/cribbage
	$(FIXIN) $(INST_SCRIPT)/cribbage
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/cribbage
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Cribbage game engine'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Game-Cribbage' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Rope: '\''0.35'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  ntheory: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Cribbage game engine",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Game-Cribbage",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Rope" : "0.35",' >> META_new.json
	$(NOECHO) $(ECHO) '            "ntheory" : "0",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Game-Cribbage" VERSION="0.03">' > Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Cribbage game engine</ABSTRACT>' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>LNATION &lt;email@lnation.org&gt;</AUTHOR>' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,006,0,0" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="List::Util" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Rope::" VERSION="0.35" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="ntheory::" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="darwin-thread-multi-2level-5.30" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Game-Cribbage.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Game-Cribbage.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Game/Cribbage.pm' 'blib/lib/Game/Cribbage.pm' \
	  'lib/Game/Cribbage/Board.pm' 'blib/lib/Game/Cribbage/Board.pm' \
	  'lib/Game/Cribbage/Deck.pm' 'blib/lib/Game/Cribbage/Deck.pm' \
	  'lib/Game/Cribbage/Deck/Card.pm' 'blib/lib/Game/Cribbage/Deck/Card.pm' \
	  'lib/Game/Cribbage/Error.pm' 'blib/lib/Game/Cribbage/Error.pm' \
	  'lib/Game/Cribbage/Hands.pm' 'blib/lib/Game/Cribbage/Hands.pm' \
	  'lib/Game/Cribbage/Play.pm' 'blib/lib/Game/Cribbage/Play.pm' \
	  'lib/Game/Cribbage/Play/Card.pm' 'blib/lib/Game/Cribbage/Play/Card.pm' \
	  'lib/Game/Cribbage/Play/Score.pm' 'blib/lib/Game/Cribbage/Play/Score.pm' \
	  'lib/Game/Cribbage/Player.pm' 'blib/lib/Game/Cribbage/Player.pm' \
	  'lib/Game/Cribbage/Player/Hand.pm' 'blib/lib/Game/Cribbage/Player/Hand.pm' \
	  'lib/Game/Cribbage/Round.pm' 'blib/lib/Game/Cribbage/Round.pm' \
	  'lib/Game/Cribbage/Round/Score.pm' 'blib/lib/Game/Cribbage/Round/Score.pm' \
	  'lib/Game/Cribbage/Rounds.pm' 'blib/lib/Game/Cribbage/Rounds.pm' \
	  'lib/Game/Cribbage/Score.pm' 'blib/lib/Game/Cribbage/Score.pm' 
